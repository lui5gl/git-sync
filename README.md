...
- `↑/↓` navegar, `Enter` o `e` editar, `a` añadir, `d` eliminar, `s` activar/pausar sync, `u` sincronizar seleccionado, `U` sincronizar todo, `v` abrir shell en la ruta, `Espacio` ver detalles, `q/Esc` salir.
